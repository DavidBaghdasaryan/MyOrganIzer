...
/// <summary>
/// Reusable maxillary-central-incisor segmentation rules. Classifies in
/// tooth-local space after family orientation:
/// +Z incisal, +Y buccal, −Y palatal.
/// Laterality.Left (FDI 21): +X mesial, −X distal; no post-align MirrorX.
/// Laterality.Right (FDI 11): post-align MirrorX; Mesial/Distal labels swap
/// so names stay anatomical. Never copies canine, premolar, or molar triangle indices.
/// Occlusal/color 0 is the cervical neck band. The crown walls are
/// Buccal/Palatal/Mesial/Distal. Inner surface is Palatal.
/// </summary>
internal static class MaxillaryCentralIncisorTemplate
{
    public const string OrientationProfile = "MaxillaryCentralIncisor";
    public const string PipelineSource =
        "maxillary-central-incisor-template+cervical-occlusal+cingulum-palatal";
    ...
    public static ClinicalSurfaceMap Generate(MeshGeometry3D crown, ToothSide laterality = ToothSide.Right)
    {
        ...
        try
        {
            ...
            var line = "{\"sessionId\":\"ee2893\",\"runId\":\"fdi11-template\",\"hypothesisId\":\"D\",\"location\":\"MaxillaryCentralIncisorTemplate.cs\",\"message\":\"generated\",\"data\":{\"laterality\":\"" +
