...
/// <summary>
/// Reusable mandibular-central-incisor segmentation rules. Classifies in
/// tooth-local space after family orientation:
/// +Z incisal, +Y buccal, −Y lingual.
/// Laterality.Left (FDI 31): +X mesial, −X distal; no post-align MirrorX.
/// Laterality.Right (FDI 41): post-align MirrorX; Mesial/Distal labels
/// swap so names stay anatomical. Never copies maxillary-incisor or canine
/// triangle indices.
/// Occlusal/color 0 is the cervical neck band (visible collar, like 33).
/// The crown walls are Buccal/Lingual/Mesial/Distal. Inner surface is
/// Lingual (enum Palatal).
/// </summary>
internal static class MandibularCentralIncisorTemplate
{
    public const string OrientationProfile = "MandibularCentralIncisor";
    public const string PipelineSource =
        "mandibular-central-incisor-template+cervical-occlusal+cingulum-lingual";
