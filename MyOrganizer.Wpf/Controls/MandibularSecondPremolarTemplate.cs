...
/// <summary>
/// Reusable mandibular second-premolar segmentation rules. Classifies in
...
/// </summary>
internal static class MandibularSecondPremolarTemplate
{
    public const string OrientationProfile = "MandibularSecondPremolar";
    public const string PipelineSource =
        "mandibular-second-premolar-template+cervical-occlusal+upper-wall-topology";
    ...
    public static ClinicalSurfaceMap Generate(MeshGeometry3D crown, ToothSide laterality = ToothSide.Left)
    {
        ...
        try
        {
            ...
            var line = "{\"sessionId\":\"ee2893\",\"runId\":\"fdi35-template\",\"hypothesisId\":\"D\",\"location\":\"MandibularSecondPremolarTemplate.cs\",\"message\":\"generated\",\"data\":{\"laterality\":\"" +
