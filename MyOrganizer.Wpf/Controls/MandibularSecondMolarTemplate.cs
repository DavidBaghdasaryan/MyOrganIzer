...
/// <summary>
/// Reusable mandibular second-molar segmentation rules in tooth-local space
/// after family orientation: +Z occlusal, +Y buccal, −Y lingual.
/// Laterality.Left (FDI 37): no post-align MirrorX; +X mesial, −X distal.
/// Laterality.Right (FDI 47): post-align MirrorX keeps buccal/lingual/occlusal
...
/// indices or world coordinates from FDI 36.
/// </summary>
internal static class MandibularSecondMolarTemplate
{
    public const string OrientationProfile = "MandibularSecondMolar";
    public const string PipelineSource =
        "mandibular-second-molar-template+cervical-red-band+seal-wall-holes";
    ...
    public static ClinicalSurfaceMap Generate(MeshGeometry3D crown, ToothSide laterality = ToothSide.Left)
    {
        ...
        try
        {
            ...
            var line = "{\"sessionId\":\"ee2893\",\"runId\":\"fdi37-template\",\"hypothesisId\":\"D\",\"location\":\"MandibularSecondMolarTemplate.cs\",\"message\":\"generated\",\"data\":{\"laterality\":\"" +
