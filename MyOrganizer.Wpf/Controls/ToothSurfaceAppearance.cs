...
public static class ToothSurfaceAppearance
{
    ...
    public static Brush FillFor(string? key)
    {
        ...
        {
            Filling => Solid(0xF2, 0xC5, 0xCB, 0xD1),
            Caries => Solid(0xF0, 0x8D, 0x6E, 0x4A),
            Crown => Solid(0xF2, 0xD5, 0xDA, 0xE0),
            Implant => Solid(0xE8, 0x6B, 0x72, 0x80),
            Endo => Solid(0xD0, 0xC6, 0x28, 0x28),
            Extraction => Solid(0xB8, 0xE5, 0xE7, 0xEB),
            Missing => Solid(0x88, 0xF3, 0xF4, 0xF6),
            Temporary => Solid(0xF2, 0xF6, 0xE7, 0xC1),
            Bridge => Solid(0xE8, 0xB0, 0xB8, 0xC4),
            Custom => Solid(0xE0, 0x93, 0xC5, 0xFD),
