...
internal static class MaxillaryCanineTemplate
{
    ...
    public static ClinicalSurfaceMap Generate(MeshGeometry3D crown, ToothSide laterality = ToothSide.Right)
    {
        ...
        try
        {
            ...
            var line = "{\"sessionId\":\"ee2893\",\"runId\":\"fdi13-template\",\"hypothesisId\":\"D\",\"location\":\"MaxillaryCanineTemplate.cs\",\"message\":\"generated\",\"data\":{\"laterality\":\"" +
                       ...
                       ",\"distal\":" + map.Counts[4] + ",\"copiedPremolarTriangleIds\":false" +
